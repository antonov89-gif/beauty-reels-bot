...
- **Era / period aesthetic lock (optional):** [palette, lighting quality, texture/grain specific to this era — if the project has a `story-bible.md` with a timeline, pull the matching era's aesthetic-differentiation block from there rather than re-deriving it here]
