...
M2 Studio's locked camera grammar (clean spherical lens character at a wide aperture, mild diffusion bloom, saturated editorial grade with warm-retained blacks) is exactly right for a product-style reveal — the specialist handles all of that.
